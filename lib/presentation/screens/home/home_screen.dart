...
import 'package:nhom2_thecoffeehouse/pages/home_page.dart';
import 'package:nhom2_thecoffeehouse/pages/order_page.dart';
import 'package:nhom2_thecoffeehouse/pages/store_page.dart';
import 'package:nhom2_thecoffeehouse/widgets/bottom_navigation.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Widget> _pages = [
    ...
    const OrderPage(key: PageStorageKey('OrderPage')),
